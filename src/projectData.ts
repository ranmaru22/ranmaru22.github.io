...
export const projects: Project[] = [
  ...
  },
  {
    ...
    alt: "DiviBot",
    label: "DiviBot",
    description: "A simple Discord bot written in Rust that helps with dice rolling for pen & paper RPGs.",
  ...
  },
  {
    ...
    alt: "marsbar",
    label: "marsbar",
    description: "A simple Übersicht bar to be used alongside yabai WM.",
  ...
  },
  {
    ...
    description: "Solutions for the exercises of the University of Helsinki's Full Stack Open certificate.",
  ...
  },
  {
    ...
    alt: "Odinbook",
    label: "Odinbook",
    description: "A Facebook clone written in pure TypeScript as capstone for The Odin Project.",
  ...
  },
  {
    ...
    description: "Solutions for the exercises of The Odin Project's full-stack node.js curriculum.",
